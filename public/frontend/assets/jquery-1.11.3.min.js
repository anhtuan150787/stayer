...
!function(r,qa){"object"==typeof module&&"object"==typeof module.exports?module.exports=r.document?qa(r,!0):function(r){if(!r.document)throw Error("jQuery requires a window with a document");return qa(r)}:qa(r)}("undefined"!=typeof window?window:this,function(r,qa){function La(a){var b="length"in a&&a.length,d=c.type(a);return"function"===d||c.isWindow(a)?!1:1===a.nodeType&&b?!0:"array"===d||0===b||"number"==typeof b&&0<b&&b-1 in a}function Ma(a,b,d){if(c.isFunction(b))return c.grep(a,function(a,
