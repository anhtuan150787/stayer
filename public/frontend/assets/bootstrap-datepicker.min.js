...
a.endDate?a.endDate instanceof Date?this._local_to_utc(this._zero_time(a.endDate)):m.parseDate(a.endDate,b,a.language):Infinity);a.daysOfWeekDisabled=a.daysOfWeekDisabled||[];d.isArray(a.daysOfWeekDisabled)||(a.daysOfWeekDisabled=a.daysOfWeekDisabled.split(/[,\s]*/));a.daysOfWeekDisabled=d.map(a.daysOfWeekDisabled,function(a){return parseInt(a,10)});var b=String(a.orientation).toLowerCase().split(/\s+/g),c=a.orientation.toLowerCase(),b=d.grep(b,function(a){return/^auto|left|right|top|bottom$/.test(a)});
...
delete this.element.data().datepicker}};var G=d.fn.datepicker;d.fn.datepicker=function(a){var b=Array.apply(null,arguments);b.shift();var c;this.each(function(){var h=d(this),f=h.data("datepicker"),g="object"===typeof a&&a;if(!f){var f=D(this,"date"),e=d.extend({},z,f,g),e=E(e.language),g=d.extend({},z,e,f,g);h.is(".input-daterange")||g.inputs?(f={inputs:g.inputs||h.find("input").toArray()},h.data("datepicker",f=new C(this,d.extend(g,f)))):h.data("datepicker",f=new v(this,g))}if("string"===typeof a&&
...
a,k);break;case "w":a.setUTCDate(a.getUTCDate()+7*k);break;case "y":a=v.prototype.moveYear.call(v.prototype,a,k)}}return t(a.getUTCFullYear(),a.getUTCMonth(),a.getUTCDate(),0,0,0)}g=a&&a.match(this.nonpunctuation)||[];a=new Date;var f={},p="yyyy yy M MM m mm d dd".split(" ");k={yyyy:function(a,b){return a.setUTCFullYear(b)},yy:function(a,b){return a.setUTCFullYear(2E3+b)},m:function(a,b){if(isNaN(a))return a;for(--b;0>b;)b+=12;b%=12;for(a.setUTCMonth(b);a.getUTCMonth()!==b;)a.setUTCDate(a.getUTCDate()-
