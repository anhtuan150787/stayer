...
g=/\s?auto?\s?/i,h=g.test(a);h&&(a=a.replace(g,"")||"top");d.detach().css({top:0,left:0,display:"block"}).addClass(a).data("bs."+this.type,this);this.options.container?d.appendTo(this.options.container):d.insertAfter(this.$element);this.$element.trigger("inserted.bs."+this.type);var g=this.getPosition(),f=d[0].offsetWidth,m=d[0].offsetHeight;if(h){var h=a,k=this.getPosition(this.$viewport),a="bottom"==a&&g.bottom+m>k.bottom?"top":"top"==a&&g.top-m<k.top?"bottom":"right"==a&&g.right+f>k.width?"left":
"left"==a&&g.left-f<k.left?"right":a;d.removeClass(h).addClass(a)}g=this.getCalculatedOffset(a,g,f,m);this.applyPlacement(g,a);a=function(){var a=c.hoverState;c.$element.trigger("shown.bs."+c.type);c.hoverState=null;"out"==a&&c.leave(c)};b.support.transition&&this.$tip.hasClass("fade")?d.one("bsTransitionEnd",a).emulateTransitionEnd(e.TRANSITION_DURATION):a()}}};e.prototype.applyPlacement=function(d,a){var c=this.tip(),g=c[0].offsetWidth,h=c[0].offsetHeight,e=parseInt(c.css("margin-top"),10),f=parseInt(c.css("margin-left"),
10);isNaN(e)&&(e=0);isNaN(f)&&(f=0);d.top+=e;d.left+=f;b.offset.setOffset(c[0],b.extend({using:function(a){c.css({top:Math.round(a.top),left:Math.round(a.left)})}},d),0);c.addClass("in");var f=c[0].offsetWidth,k=c[0].offsetHeight;"top"==a&&k!=h&&(d.top=d.top+h-k);var n=this.getViewportAdjustedDelta(a,d,f,k);n.left?d.left+=n.left:d.top+=n.top;g=(e=/top|bottom/.test(a))?2*n.left-g+f:2*n.top-h+k;h=e?"offsetWidth":"offsetHeight";c.offset(d);this.replaceArrow(g,c[0][h],e)};e.prototype.replaceArrow=function(b,
a,c){this.arrow().css(c?"left":"top",50*(1-b/a)+"%").css(c?"top":"left","")};e.prototype.setContent=function(){var b=this.tip(),a=this.getTitle();b.find(".tooltip-inner")[this.options.html?"html":"text"](a);b.removeClass("fade in top bottom left right")};e.prototype.hide=function(d){function a(){"in"!=c.hoverState&&g.detach();c.$element.removeAttr("aria-describedby").trigger("hidden.bs."+c.type);d&&d()}var c=this,g=b(this.$tip),f=b.Event("hide.bs."+this.type);return this.$element.trigger(f),f.isDefaultPrevented()?
void 0:(g.removeClass("in"),b.support.transition&&g.hasClass("fade")?g.one("bsTransitionEnd",a).emulateTransitionEnd(e.TRANSITION_DURATION):a(),this.hoverState=null,this)};e.prototype.fixTitle=function(){var b=this.$element;(b.attr("title")||"string"!=typeof b.attr("data-original-title"))&&b.attr("data-original-title",b.attr("title")||"").attr("title","")};e.prototype.hasContent=function(){return this.getTitle()};e.prototype.getPosition=function(d){d=d||this.$element;var a=d[0],c="BODY"==a.tagName,
a=a.getBoundingClientRect();null==a.width&&(a=b.extend({},a,{width:a.right-a.left,height:a.bottom-a.top}));var g=c?{top:0,left:0}:d.offset();d={scroll:c?document.documentElement.scrollTop||document.body.scrollTop:d.scrollTop()};c=c?{width:b(window).width(),height:b(window).height()}:null;return b.extend({},a,d,c,g)};e.prototype.getCalculatedOffset=function(b,a,c,g){return"bottom"==b?{top:a.top+a.height,left:a.left+a.width/2-c/2}:"top"==b?{top:a.top-g,left:a.left+a.width/2-c/2}:"left"==b?{top:a.top+
a.height/2-g/2,left:a.left-c}:{top:a.top+a.height/2-g/2,left:a.left+a.width}};e.prototype.getViewportAdjustedDelta=function(b,a,c,g){var d={top:0,left:0};if(!this.$viewport)return d;var f=this.options.viewport&&this.options.viewport.padding||0,e=this.getPosition(this.$viewport);/right|left/.test(b)?(c=a.top-f-e.scroll,a=a.top+f-e.scroll+g,c<e.top?d.top=e.top-c:a>e.top+e.height&&(d.top=e.top+e.height-a)):(g=a.left-f,a=a.left+f+c,g<e.left?d.left=e.left-g:a>e.right&&(d.left=e.left+e.width-a));return d};
...
this.$arrow||this.tip().find(".tooltip-arrow")};e.prototype.enable=function(){this.enabled=!0};e.prototype.disable=function(){this.enabled=!1};e.prototype.toggleEnabled=function(){this.enabled=!this.enabled};e.prototype.toggle=function(d){var a=this;d&&(a=b(d.currentTarget).data("bs."+this.type),a||(a=new this.constructor(d.currentTarget,this.getDelegateOptions()),b(d.currentTarget).data("bs."+this.type,a)));d?(a.inState.click=!a.inState.click,a.isInStateTrue()?a.enter(a):a.leave(a)):a.tip().hasClass("in")?
a.leave(a):a.enter(a)};e.prototype.destroy=function(){var b=this;clearTimeout(this.timeout);this.hide(function(){b.$element.off("."+b.type).removeData("bs."+b.type);b.$tip&&b.$tip.detach();b.$tip=null;b.$arrow=null;b.$viewport=null})};var f=b.fn.tooltip;b.fn.tooltip=function(d){return this.each(function(){var a=b(this),c=a.data("bs.tooltip"),g="object"==typeof d&&d;!c&&/destroy|hide/.test(d)||(c||a.data("bs.tooltip",c=new e(this,g)),"string"!=typeof d||c[d]())})};b.fn.tooltip.Constructor=e;b.fn.tooltip.noConflict=
...
b(this),a=a.data("target")||a.attr("href"),g=/^#./.test(a)&&b(a);return g&&g.length&&g.is(":visible")&&[[g[c]().top+d,a]]||null}).sort(function(a,b){return a[0]-b[0]}).each(function(){a.offsets.push(this[0]);a.targets.push(this[1])})};e.prototype.process=function(){var a,b=this.$scrollElement.scrollTop()+this.options.offset,d=this.getScrollHeight(),e=this.options.offset+d-this.$scrollElement.height(),f=this.offsets,m=this.targets,k=this.activeTarget;if(this.scrollHeight!=d&&this.refresh(),b>=e)return k!=
(a=m[m.length-1])&&this.activate(a);if(k&&b<f[0])return this.activeTarget=null,this.clear();for(a=f.length;a--;)k!=m[a]&&b>=f[a]&&(void 0===f[a+1]||b<f[a+1])&&this.activate(m[a])};e.prototype.activate=function(a){this.activeTarget=a;this.clear();a=b(this.selector+'[data-target="'+a+'"],'+this.selector+'[href="'+a+'"]').parents("li").addClass("active");a.parent(".dropdown-menu").length&&(a=a.closest("li.dropdown").addClass("active"));a.trigger("activate.bs.scrollspy")};e.prototype.clear=function(){b(this.selector).parentsUntil(this.options.target,
...
"function"==typeof e&&(e=c.bottom(this.$element));c=this.getState(l,a,d,e);if(this.affixed!=c){null!=this.unpin&&this.$element.css("top","");var d="affix"+(c?"-"+c:""),m=b.Event(d+".bs.affix");if(this.$element.trigger(m),m.isDefaultPrevented())return;this.affixed=c;this.unpin="bottom"==c?this.getPinnedOffset():null;this.$element.removeClass(f.RESET).addClass(d).trigger(d.replace("affix","affixed")+".bs.affix")}"bottom"==c&&this.$element.offset({top:l-a-e})}};var d=b.fn.affix;b.fn.affix=e;b.fn.affix.Constructor=
