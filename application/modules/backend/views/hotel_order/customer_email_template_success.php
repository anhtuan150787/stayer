<div style="margin-top:10px; color: black">
    ...
    <p style="line-height: 1.7; color: black;">
        Đơn đặt phòng của bạn đã thành công.<br>
        ...
        Mã đặt phòng: <br /><b style="font-size: 20px;"><?php echo html_escape($order->order_code);?></b>
    </p>
        <div>
            <div >
...
<p style="line-height: 1.7; color: black;">
    Lưu ý:<br>
    Khi nhận phòng tại khách sạn, bạn vui lòng cung cấp CMND và phiếu nhận phòng cho chủ khách sạn.<br>
    Download và in phiếu nhận phòng tại link:<br>
    <?php echo site_url() . '/backend/api/export_pdf_order_hotel/?auth=' . $hash_auth . '&id=' . $order->id;?>
</p>