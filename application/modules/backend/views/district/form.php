                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="type">
                            ...
                            <option <?php echo (isset($record->type) && $record->type == 'Quận') ? 'selected="selected"' : ''; ?> value="Quận">Quận</option>
                            <option <?php echo (isset($record->type) && $record->type == 'Huyện') ? 'selected="selected"' : ''; ?> value="Huyện">Huyện</option>
                            <option <?php echo (isset($record->type) && $record->type == 'Thị Xã') ? 'selected="selected"' : ''; ?> value="Thị Xã">Thị Xã</option>
                        </select>
                    </div>
                </div>
