        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea rows="2" name="description" id="description" class="input-block-level"><?php echo (isset($record->description)) ? html_escape($record->description) : ''; ?></textarea>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <?php $menu = require APPPATH . 'modules/backend/assets/config_menu.php'; ?>
<?php foreach ($menu as $k => $v) : ?>
    ...
    <?php foreach ($v['item'] as $kk => $vv) : ?>
                                        <table class="table table-nomargin group-permission">
                                            <thead>
                                                <tr><th class="controller"><?php echo $vv['name']; ?></th>
                                                ...
                                                <tr>
                                                    <td></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input <?php echo (in_array($value_permission, $str_permission)) ? 'checked="checked"' : ''; ?> name="permission[]" type="checkbox" value="<?php echo $value_permission; ?>"/>
                                                        </td>
                                                    <?php endforeach; ?>
                                                </tr>
                                            </tbody>
