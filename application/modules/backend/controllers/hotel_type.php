...
class Hotel_type extends Backend_Controller
{

    protected $limit = 20;
    
    protected $model = 'hotel_type_model';
    ...
    public function __construct()
    {
         ...
         * Title trang
         */
        $this->data['title'] = 'Loại khách sạn';
        ...
        $this->data['breadcrumbs'] = array(
            ...
            'Loại khách sạn' => site_url() . '/backend/' . $this->data['controller'],
        );
        
        /*
         * Load js
         */
        $this->data['js'] = array('hotel_type.js');
    }
