...
class Room_type_facilities extends Backend_Controller
{

    protected $limit = 20;
    
    protected $model = 'room_type_facilities_model';
    ...
    public function __construct()
    {
         ...
         * Title trang
         */
        $this->data['title'] = 'Tiện nghi loại phòng';
        ...
        $this->data['breadcrumbs'] = array(
            ...
            'Tiện nghi loại phòng' => site_url() . '/backend/' . $this->data['controller'],
        );
        
        /*
         * Load js
         */
        $this->data['js'] = array('room_type_facilities.js');
    }
