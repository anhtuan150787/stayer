...
class Tour_topic extends Backend_Controller
{

    protected $limit = 20;

    protected $model = 'tour_topic_model';
    ...
    public function __construct()
    {
        ...
        $this->data['breadcrumbs'] = array(
            ...
            'Chủ đề tour' => site_url() . '/backend/' . $this->data['controller'],
        );

        /*
         * Load js
         */
        $this->data['js'] = array('tour_topic.js');
    }
