...
class Area extends Backend_Controller
{
    ...
    public function __construct()
    {
         ...
         * Title trang
         */
        $this->data['title'] = 'Miền';

        /*
         * Load model
         */
        $this->load->model(array($this->model, 'national_model'));
        ...
        $this->data['breadcrumbs'] = array(
            ...
            'Miền' => site_url() . '/backend/' . $this->data['controller'],
        );
        
        /*
         * Load js
         */
        $this->data['js'] = array('area.js');
    }
    ...
    public function index()
    {
         ...
         * Data view
         */
        $this->{$this->model}->select('area.*, national.name as national_name');
        $this->{$this->model}->join('national', 'area.national_id = national.id', 'left');
        $this->{$this->model}->where(array('area.deleted' => 0));
