...
class District extends Backend_Controller
{
    ...
    protected $model = 'district_model';
    ...
    public function __construct()
    {
        ...
        $this->data['breadcrumbs'] = array(
            ...
            'Quận/Huyện' => site_url() . '/backend/' . $this->data['controller'],
        );
        
        /*
         * Load js
         */
        $this->data['js'] = array('district.js');
    }
    ...
    public function index()
    {
         ...
         * Data view
         */
        $this->{$this->model}->select('district.*, province.name as province_name');
        $this->{$this->model}->join('province', 'district.province_id = province.id', 'left');
        $this->{$this->model}->where(array('district.deleted' => 0));
        $this->{$this->model}->order_by('district.id', 'desc');
    ...
    public function add()
    {
         ...
         * Quoc gia
         */
        $this->data['national'] = $this->national_model->find_all();
