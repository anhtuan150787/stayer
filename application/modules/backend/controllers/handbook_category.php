...
class Handbook_category extends Backend_Controller
{   
    protected $model = 'handbook_category_model';
    ...
    public function __construct()
    {
         ...
         * Title trang
         */
        $this->data['title'] = 'Chuyên mục cẩm nang';
        ...
        $this->data['breadcrumbs'] = array(
            ...
            'Chuyên mục cẩm nang' => site_url() . '/backend/' . $this->data['controller'],
        );
