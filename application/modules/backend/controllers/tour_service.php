...
class Tour_service extends Backend_Controller
{

    protected $limit = 20;

    protected $model = 'tour_service_model';
    ...
    public function __construct()
    {
        ...
        $this->data['breadcrumbs'] = array(
            ...
            'Dịch vụ tour' => site_url() . '/backend/' . $this->data['controller'],
        );

        /*
         * Load js
         */
        $this->data['js'] = array('tour_service.js');
    }
