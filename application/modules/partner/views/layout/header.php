...
<head>
    ...
    <!-- Timeline CSS -->
    <link href="<?php echo base_url(); ?>public/partner/dist/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?php echo base_url(); ?>public/partner/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<?php echo base_url(); ?>public/partner/bower_components/morrisjs/morris.css" rel="stylesheet">
    ...
    <!-- Jquery UI CSS -->
    <link href="<?php echo base_url(); ?>public/partner/css/jquery-ui.css" rel="stylesheet" />
