 ...
 *
 */
class Partner_bk_model extends CI_Model
{
    ...
    */
    ...
    public function find_where_in($field=NULL, $value=NULL, $type='in', $return_type = 0){
        if (empty($field)) return FALSE;
     ...
     * @return bool TRUE/FALSE
     */
    public function update_where($field=NULL, $data=NULL)
    {
